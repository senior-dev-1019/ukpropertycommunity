    ...
    <div class="max-width-1200">
        ...
        <div class="flexbox-annotated-section" style="border: none">
            ...
            <div class="flexbox-annotated-section-content">
                ...
                <a class="btn btn-warning btn-trigger-reset-to-default" data-bs-target="{{ route('setting.email.template.reset-to-default') }}">{{ trans('core/setting::setting.email.reset_to_default') }}</a>
