                ...
                @if('layout-1' === $headerLayout)
                    <div class="property_block_wrap style-2 p-4">
                        <div class="prt-detail-title-desc">
                            ...
                            <h3>{{ $property->name }}</h3>
                            <p><span><i class="lni-map-marker"></i> {{ $property->location . ', ' . $property->city_name }}</span></p>
                            @if(!empty($property->epc))
                                <p><i class="lni-bookmark-alt mt-4"></i> EPC : <b>{{ $property->epc }}</b></p>
                            @endif
                            ...
                            <div class="sides-widget-header">
                                @if ($author->username)
                                    ...
                                    <div class="sides-widget-details">
                                        ...
                                        <p><span><i class="lni-phone-handset"></i>{{ $author->phone }}</span></p>
                                        @if($property->original_link)
                                            <p><spane><i class="lni-link"></i>&nbsp;&nbsp;&nbsp;<a href="{{ $property->original_link }}">Rightmove</a></spane></p>
                                        @endif
                                    </div>
