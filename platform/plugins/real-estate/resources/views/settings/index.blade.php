                ...
                <div class="wrapper-content pd-all-20">
                    <div class="form-group">
                        ...
                        <label class="hrv-label">
                            <input type="radio" name="real_estate_convert_money_to_text_enabled" class="hrv-radio" value="1"
                        ...
                        <label class="hrv-label">
                            <input type="radio" name="real_estate_convert_money_to_text_enabled" class="hrv-radio" value="0"
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    <div class="form-group">
                        ...
                        <label class="hrv-label">
                            <input type="radio" name="real_estate_review_enabled" class="hrv-radio" value="1" @if (is_review_enabled()) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                        </label>
                        <label class="hrv-label">
                            <input type="radio" name="real_estate_review_enabled" class="hrv-radio" value="0" @if (!is_review_enabled()) checked @endif>{{ trans('core/setting::setting.general.no') }}
                        </label>
                    </div>
