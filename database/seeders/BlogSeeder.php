...
class BlogSeeder extends BaseSeeder
{
    ...
    public function run()
    {
        ...
        foreach ($dataTags as $locale => $tags) {
        ...
        foreach ($dataCategory as $locale => $categories) {
            foreach ($categories as $index => $item) {
                ...
                LanguageMeta::saveMetaData($categoryDetail, $locale, $originValue);
            }
        }
        ...
        foreach ($data as $locale => $posts) {
            ...
            foreach ($posts as $index => $item) {
                ...
                $post->categories()->sync($locale == 'en_US' ? [Arr::random([1, 2, 4, 6])] : [
                    Arr::random([
                        3,
                        5,
                        7,
